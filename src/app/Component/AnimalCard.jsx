...
const AnimalCard = ({animal}) => {
    console.log(animal);
    return (
        <div key={animal.id} className="bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100 flex flex-col hover:shadow-md transition-all duration-300">
                        ...
                        <div className="p-5 flex-grow">
                            ...
                            <div className="flex gap-2">
                                <button className="flex-1 py-2.5 border border-[#1a2e1a] text-[#1a2e1a] rounded-xl text-sm font-bold hover:bg-gray-50 transition-all">
                                    Details
                                </button>
                                <button className="flex-1 py-2.5 bg-[#1a2e1a] text-white rounded-xl text-sm font-bold hover:bg-green-900 transition-all shadow-lg shadow-green-900/10">
                                    Book Now
                                </button>
                            </div>
                        </div>
